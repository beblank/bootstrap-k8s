...
curl --silent -L https://github.com/coreos/terraform-provider-matchbox/releases/download/v0.2.2/terraform-provider-matchboxv0.2.2-linux-amd64.tar.gz -o "terraform-provider-matchbox.tar.gz"
unzip terraform.zip
